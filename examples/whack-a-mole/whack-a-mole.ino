...
void setup() {
  ...
  game.setHelpContent("How to play this game","Toggle the 'start the game' switch to start the game.<br /><br />Every time a button lights, press it. If you whack enough you will win.<br /><br />When you win all the controls turn green.<br /><br />If you don't hit all the buttons fast enough all the controls turn red.<br /><br />You can restart the game by flicking the 'Start the game' switch.");
